							...
							<div class="card mt-4">
								<div class="card-body p-4">
									<div class="text-center mt-2">
										<h5 class="text-primary" style="color:#23b24b !important">Student Login</h5>
									</div>
									<div class="p-2 mt-4">
										<form class="needs-validation" novalidate action="{{ route('student.login') }}" method="POST" >
											@csrf
											<div class="mb-3">
											...
											<div class="mt-4 text-center">
												<div class="signin-other-title">
													<a href=""class="fs-13 mb-4 title">Forget password</a>
												</div>
											</div>
											{{--       
											<div class="mt-4 text-center">
